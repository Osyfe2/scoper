...
use scoper_base::Info;

use crate::{record_custom_scope, TimePoint};

thread_local! {
    static OPEN_SCOPES: RefCell<Vec<TimePoint>> = RefCell::default();
}

pub(crate) struct Start(pub TimePoint);
